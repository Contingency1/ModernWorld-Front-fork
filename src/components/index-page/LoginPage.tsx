  ...
  return (
    <S.BackgroundColor style={{ backgroundColor: '#5F6F52' }}>
      <S.MainLogo $grid1="40%" $grid2="11%" $grid3="11%" $grid4="11%">
        ...
        <S.LoginBtnLink
          href={`https://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=_udRI5pXQrnMsGMQKOZV&redirect_uri=${process.env.NEXT_PUBLIC_LOCALHOST}/naver/auth/callback&state=test&auth_type=reauthenticate`}
          color="#03C75A"
          $textColor="#ffffff"
          $imgWidth="35%"
          $imgHeight="100%"
        ...
        <S.LoginBtnLink
          href={`https://kauth.kakao.com/oauth/authorize?client_id=96134462004a89d97aae97440496559e&redirect_uri=${process.env.NEXT_PUBLIC_LOCALHOST}/kakao/auth/callback&response_type=code&prompt=login`}
          color="#FEE500"
          $textColor="#000000"
          $imgWidth="25%"
          $imgHeight="80%"
